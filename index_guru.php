...
if(isset($_SESSION['username'])&& isset($_SESSION['password'])){
	...
	//untuk menampilkan data dari tabel user dimana username sama dengan $username dan password sama dengan $password 
...
<td align="right">
<a href="mapel.php" target="tengah"  class="menu">Mata Pelajaran</a>
...
<?php
...

  {
    ...
    echo "<a href=\"login_guru.php\" class=\"link\">Silahkan Login</a> !</div>";
}
?>
</body>
</html>